...
var _fifth_postulate$brainbow$Brainbow$segment = F5(
	function (debug, position, index, total, radius) {
		var message = debug ? _elm_lang$core$Basics$toString(index) : '';
		var r = _elm_lang$core$Basics$toFloat(radius);
		var baseAngle = (2 * _elm_lang$core$Basics$pi) / _elm_lang$core$Basics$toFloat(total);
		var alpha = _elm_lang$core$Basics$toFloat(position) * baseAngle;
		var x0 = r * _elm_lang$core$Basics$cos(alpha);
		var y0 = r * _elm_lang$core$Basics$sin(alpha);
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(xt)),
							_elm_lang$svg$Svg_Attributes$y(
							_elm_lang$core$Basics$toString(yt)),
...
var _fifth_postulate$brainbow$Brainbow$bow = F3(
	function (debug, radius, permutation) {
		var total = _elm_lang$core$List$length(permutation);
		var mapper = F2(
			function (position, index) {
				return A5(_fifth_postulate$brainbow$Brainbow$segment, debug, position, index, total, radius);
			});
		return A2(_elm_lang$core$List$indexedMap, mapper, permutation);
	});
var _fifth_postulate$brainbow$Brainbow$viewPermutationAsSvg = function (model) {
	var radius = model.radius;
	var dimension = _elm_lang$core$Basics$toString(2 * radius);
	var viewbox = A2(
		_elm_lang$core$String$join,
		' ',
		A2(
			...
			_elm_lang$core$Basics$toString,
			_elm_lang$core$Native_List.fromArray(
				[0 - radius, 0 - radius, 2 * radius, 2 * radius])));
	var permutation = model.permutation;
	var size = _elm_lang$core$List$length(permutation) - 1;
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$width(dimension),
				_elm_lang$svg$Svg_Attributes$height(dimension),
				_elm_lang$svg$Svg_Attributes$viewBox(viewbox)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				A3(_fifth_postulate$brainbow$Brainbow$bow, model.debug, radius, permutation)),
				A2(
				_elm_lang$svg$Svg$g,
				_elm_lang$core$Native_List.fromArray(
					[]),
...
var _fifth_postulate$brainbow$Brainbow$swapFirst = function (permutation) {
	...
	var first = _elm_lang$core$Basics$fst(parts);
...
var _fifth_postulate$brainbow$Brainbow$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			...
			case 'Decrease':
				var newSize = A2(_elm_lang$core$Basics$max, 2, model.size - 1);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							debug: _elm_lang$core$Basics$not(model.debug)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _fifth_postulate$brainbow$Brainbow$initModel = F2(
	function (n, radius) {
		return {
...
var _fifth_postulate$brainbow$Brainbow$init = F2(
	function (n, radius) {
		return {
			ctor: '_Tuple2',
			_0: A2(_fifth_postulate$brainbow$Brainbow$initModel, n, radius),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _fifth_postulate$brainbow$Brainbow$Model = F4(
	function (a, b, c, d) {
		return {permutation: a, size: b, radius: c, debug: d};
	});
var _fifth_postulate$brainbow$Brainbow$ToggleDebug = {ctor: 'ToggleDebug'};
...
var _fifth_postulate$brainbow$Brainbow$view = function (model) {
	var dimension = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(2 * model.radius),
		'px');
	var brainbow = _fifth_postulate$brainbow$Brainbow$viewPermutationAsSvg(model);
	var swap = A2(
	...
	var rotate = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('r')
			]));
	var toggle = A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onClick(_fifth_postulate$brainbow$Brainbow$ToggleDebug)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'width', _1: dimension}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _fifth_postulate$brainbow$Brainbow$handlers = A3(
	_elm_lang$core$Dict$insert,
	68,
	_fifth_postulate$brainbow$Brainbow$ToggleDebug,
	A3(
		_elm_lang$core$Dict$insert,
		82,
		_fifth_postulate$brainbow$Brainbow$Rotate,
...
var _fifth_postulate$brainbow$Brainbow$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A2(_fifth_postulate$brainbow$Brainbow$init, 6, 240),
